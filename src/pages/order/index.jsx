...
function Index() {
   ...
   useEffect(() => {
      axios
         .get(
            `${process.env.NEXT_PUBLIC_BACKEND_URL}/booking/seat?schedule=${booking.schedule_id}&time=${booking.time}`
         )
   ...
   useEffect(() => {
      axios
         .get(`${process.env.NEXT_PUBLIC_BACKEND_URL}/booking/allseat`)
         .then((res) => {
      ...
      <>
         ...
         <main className={styles.bg}>
            <section className="row">
               <section className="col-md-12 col-sm-12 col-lg-8">
                     ...
                     <div className={styles.background_seat}>
                        ...
                        <div className={styles.container_box}>
                           <div className="d-flex flex-row">
                              <div
                                 className={`d-flex flex-column align-items-center ${styles.number_chair}`}
                              >
                              ...
                              <div className="d-flex flex-row justify-content-center gap-0 gap-md-5 gap-lg-5">
                                 <div className="d-flex flex-column align-items-center">
                                    <div
                                       className={`d-flex gap-5 flex-row align-items-center justify-content-center ${styles.chair}`}
                                    >
                                       <div className="">
                                          {seat_id.map(
                                             (e, index) =>
               ...
               <section className="col-12 col-md-6 col-lg-4 pb-5">
                  <section className={styles.order__bar}>
                  ...
                  <section className={styles.oder__content}>
                     ...
                     <h4 className={styles.title_cinema}>
                        {booking.cinema_name}
                     </h4>
                     ...
                     <section className={styles.content_bottom}>
                        ...
                        <p className={styles.total_payment}>
                           {costing(totalPayment)}
                        </p>
                     </section>
                  </section>
               </section>
